...
public class JianDaoApiUtils {

    @SuppressWarnings("unchecked")
    protected static class APIUtils {
        ...
        private String apiKey = "BLHZajcyi7wwz80nuwWgc4qw6YJOadXo";
         ...
         * @param apiKey - apiKey
         */
        public APIUtils (String appId, String entryId) {
            //this.apiKey = apiKey;
            ...
            if ("GET".equals(method)) {
                ...
                if (data != null) {
                	...
                	for(String key : data.keySet()){
                		uriBuilder.addParameter(key, (String) data.get(key));
                	}
                }
...
//        String appId = "5a367ad994de5368331b1bd0";
//        String entryId = "5b32fb7658bc5170f29c297a";
//        String apiKey = "BLHZajcyi7wwz80nuwWgc4qw6YJOadXo";
...
//    }
    ...
    public static void main(String[] args) {
	      Map<String, Object> createData = JianDaoProductAPI.create("WKSKSKX223322332", "2018-07-01", "曼天雨", "测试不用管",1, "黑色","XL","2018-07-01", "张三");
        System.out.println("创建单条数据：");
        System.out.println(createData);
	}
