...
public class JUploadUtils {
    ...
    public static File save(MultipartFile file,HttpServletRequest request) throws Exception{
        // 获取本地存储路径
//        String path = request.getSession().getServletContext().getRealPath(JConfig.getConfig(JConfig.FILEUPLOAD));
        ...
        String randomFileName = System.currentTimeMillis()+"_"+RandomUtils.nextInt(1000, 9999);
        // 设定文件名称
