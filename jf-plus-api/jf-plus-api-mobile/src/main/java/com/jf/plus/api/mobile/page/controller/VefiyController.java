...
@Controller
public class VefiyController {
	public final static String VIFIY_CODE = "VIFY_CODE";
	...
	@RequestMapping("/api/genVefiyImg")
	public void genVefiyImg(HttpServletRequest req, HttpServletResponse resp,
		...
		session.setAttribute(VIFIY_CODE, randomCode.toString());
