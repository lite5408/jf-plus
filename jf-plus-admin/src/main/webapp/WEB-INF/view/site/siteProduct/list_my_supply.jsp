                                    ...
                                    <div class="am-input-group am-input-group-sm tpl-form-border-form cl-p">
                                    	<table class="am-u-sm-12">
                                    		<tr>
                                    			...
                                    			<td>
											  		<input type="text" class="am-input-sm"  name="supplyName"  value="${page.condition.supplyName }">
												</td>
                                ...
                                <table id="contentTable" class="am-table am-table-compact am-table-striped tpl-table-black">
                                    ...
                                    <c:forEach items="${page.list}" var="product" varStatus="status">
                                        <tr>
                                                ...
                                                <td>
                                                	<div class="am-u-md-4"><img class="" width="80" height="80" src="${product.photo }"></div>
