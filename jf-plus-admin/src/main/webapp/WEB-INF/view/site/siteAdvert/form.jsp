                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-head am-cf">
                            <div class="widget-title am-fl">商城广告配置</div>
                        </div>
                        <div class="widget-body am-fr">
                            ...
                            <input type="hidden" name="id" value="${siteAdvert.id}"/>
                                    <div class="am-form-group">
                                        <label class="am-u-sm-3 am-form-label"><span class="error">*</span>标题：</label>
                                        <div class="am-u-sm-9">
                                            <input type="text" name="name" placeholder="标题" value="${siteAdvert.name}" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" name="url" placeholder="链接" value="${siteAdvert.url}"/>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        <label class="am-u-sm-3 am-form-label">排序：</label>
                                        <div class="am-u-sm-9">
                                            <input type="text" name="sort" placeholder="排序" value="${siteAdvert.sort}"/>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        <label class="am-u-sm-3 am-form-label">备注：</label>
                                        <div class="am-u-sm-9">
                                            <input type="text" name="remarks" placeholder="备注" value="${siteAdvert.remarks}"/>
                                        </div>
                                    </div>
                            <div class="am-form-group">
