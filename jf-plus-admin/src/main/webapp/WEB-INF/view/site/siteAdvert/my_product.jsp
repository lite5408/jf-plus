                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-body am-fr">
                            <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                                <form id="searchForm" action="${ctx}/site/siteAdvert/myProduct?advertId=${advertId}" method="post">
                                ...
                                <table id="contentTable" class="am-table am-table-compact am-table-striped tpl-table-black">
                                    ...
                                    <c:forEach items="${page.list}" var="product" varStatus="status">
                                        <tr>
                                                ...
                                                <td>
                                                	<div class="am-u-md-4"><img class="am-img-thumbnail" width="140" height="140" src="${fn:split(product.photo,',')[0] }"></div>
                                                ...
                                                <td>${fnc:getEnumText("com.jf.plus.common.core.enums.ProductSource",product.source)}</td>
                                                <td>${fnc:getEnumText("com.jf.plus.common.core.enums.ProductStatus",product.operStatus)}</td>
                                            <td>
                                                <div class="am-btn-group am-btn-group-xs">
							                      	<a role="oper" href="javascript:" class="am-btn am-btn-default am-btn-xs am-text-secondary" onclick="pickToSpecial('${product.id}','4','${product.source }')"><span class="am-icon-check"></span> 移出商品</a>
                                                </div>
                                            </td>
                                        </tr>
                                    </c:forEach>
   		...
   		$.post('${ctx}/site/siteAdvert/pick',{id:itemId,operStatus:operStatus,source:source,advertId:'${advertId}'},function(result){
   			if(result.success){
   				layer.msg('操作成功',{icon: 1,time: 1000},function(){
					$(target).text('已移出').attr('disabled',true);
