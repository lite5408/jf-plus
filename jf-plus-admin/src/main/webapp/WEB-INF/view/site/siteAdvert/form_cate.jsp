                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-head am-cf">
                            <div class="widget-title am-fl">首页分类设置</div>
                        </div>
                            ...
                            <input type="hidden" name="id" value="${siteAdvert.id}"/>
                                   ...
                                   <div class="am-form-group">
                                    ...
                                    <div class="am-form-group">
	                                    ...
	                                    <div class="am-u-sm-9">
	                                        <div class="am-input-group">
	                                            <input type="text" id="itemCateName" name="name" class="am-form-field" minlength="1" value="${siteAdvert.name}" required/>
	                                            <input type="hidden" id="itemCate" name="showType" value="${siteAdvert.showType}" />
											    <span class="am-input-group-btn">
													<button class="am-btn am-btn-xs am-btn-primary" type="button" id="itemCateBtn" onclick="openModelAdjust('选择商品分类','${ctx}/site/siteCate/select')">选择</button>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" name="sort" placeholder="排序" value="<c:choose><c:when test='${empty siteAdvert.sort}'>1</c:when><c:otherwise>${siteAdvert.sort }</c:otherwise></c:choose>" required/>
                                        </div>
                                    </div>
                            <div class="am-form-group">
