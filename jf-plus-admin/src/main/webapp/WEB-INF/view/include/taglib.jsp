...
<c:set var="ctxStatic" value="${pageContext.request.contextPath}/static1"/>
<c:set var="urlSuffix" value="${fnc:getConfig('urlSuffix')}"/>
<%@ page import="com.jf.plus.common.core.enums.*" %>
<c:set var="ctxS" value="${pageContext.request.contextPath}${fnc:getConfig('supplyPath')}"/>
<c:set var="imgUrl" value="${fnc:getConfig('url.image')}"/>