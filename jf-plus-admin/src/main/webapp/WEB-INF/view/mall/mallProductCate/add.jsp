                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        ...
                        <div class="widget-body am-fr">
                            ...
                            <input type="hidden" name="catPid" value="${parentMallProductCate.id}"/>
                                    <div class="am-form-group">
                                        <label class="am-u-sm-3 am-form-label">父类别：</label>
                                        <div class="am-u-sm-9">
                                            <input type="text" name="catPid" placeholder="父类别" value="${parentMallProductCate.catName}" readonly/>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        <label class="am-u-sm-3 am-form-label">编码：</label>
                                        <div class="am-u-sm-9">
                                            <input type="text" name="catCode" placeholder="类别编码" value="" required unique/>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        <label class="am-u-sm-3 am-form-label">类别名称：</label>
                                        <div class="am-u-sm-9">
                                            <input type="text" name="catName" placeholder="类别名称" value="" required/>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        <label class="am-u-sm-3 am-form-label">排序：</label>
                                        <div class="am-u-sm-9">
                                            <input type="text" name="sort" placeholder="排序" value="1" required/>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
