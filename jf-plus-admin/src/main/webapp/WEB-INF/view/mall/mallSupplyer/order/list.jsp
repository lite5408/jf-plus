                        ...
                        <div class="widget-head am-cf">
                         ...
                         <div class="widget-body am-fr">
                                ...
                                <table class="am-u-sm-12">
	                                <tr>
										<td class="am-padding-sm">
											<a href="${ctxS }/export/order/excel?pageNo=0&operStatus=${page.entity.operStatus}&itemName=${page.entity.itemName}&receiver=${page.entity.receiver}&orderNo=${page.entity.orderNo}" 
												class="am-btn am-btn-xs am-btn-success am-icon-file-excel-o" type="button"> 导出</a>
											<a role="oper" href="javascript:;" onclick="uploadFile();" class="am-btn am-btn-xs am-btn-success"><span class="am-icon-reply-all"></span> 物流导入</a>
											<a href="${ctxStatic }/fmt/物流批量导入模板.xls" class="am-btn">模板下载</a>
										</td>
                            ...
                            <div class="am-u-sm-12 am-u-md-9 am-u-lg-9">
                                <form id="searchForm" action="${ctxS}/order/list" method="post">
                                ...
                                <table id="contentTable" class="am-table am-table-compact am-table-striped tpl-table-black">
                                    ...
                                    <c:forEach items="${page.list}" var="row" varStatus="status">
                                        <tr>
                                            ...
                                            <td>
                                            	<c:if test="${row.trackState == 0 or empty row.trackState}">
	                                                <div class="am-btn-group am-btn-group-xs">
	                                                    <a role="oper" href="javascript:;" onclick="openModel('订单发货','${ctxS}/order/delivered?orderId=${row.id}')" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-check"></span> 发货</a>
	                                                </div>
                                                </c:if>
                                                <c:if test="${row.trackState == 1 }">
	                                                <div class="am-btn-group am-btn-group-xs">
	                                                    <a role="oper" href="javascript:;" onclick="openModel('订单物流','${ctxS}/order/track?orderId=${row.id}')" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-check"></span> 查看物流</a>
	                                                </div>
                                                </c:if>
                                                <c:if test="${row.trackState == 3 }">
                                                	<div class="am-btn-group am-btn-group-xs">
	                                                    <a role="oper" href="javascript:;" onclick="openModel('订单物流','${ctxS}/order/track?orderId=${row.id}')" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-check"></span> 查看物流</a>
	                                                    <a role="oper" href="javascript:;" onclick="openModel('签收信息','${ctxS}/order/confirm?orderId=${row.id}')" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-edit"></span> 签收信息</a>
	                                                </div>
                                                </c:if>
                                            </td>
                                        </tr>
...
<form id="impForm" action="${ctxS }/import/logistics/batchImport" method="post" enctype="multipart/form-data">
    <div class="am-modal am-modal-prompt" tabindex="0" id="my-prompt">
      <div class="am-modal-dialog">
        <div class="am-modal-hd">导入物流信息</div>
        <div class="am-modal-bd">
          <input type="file" name="file" id="uploadFile">
        </div>
        <div class="am-modal-footer">
        <span class="am-modal-btn" data-am-modal-cancel>取消</span>
		<input type="button" class="am-btn am-btn-xs am-btn-primary btn-loading-example" data-am-loading="{spinner: 'circle-o-notch', loadingText: '导入中....', resetText: '导入成功'}" id="submitButton" value="导入" />
        </div>
      </div>
    </div>
</form>
