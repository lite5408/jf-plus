...
<html>
<head>
    <title>新建<c:choose><c:when test="${msgSend.type=='mail'}">站内信</c:when><c:otherwise>通知</c:otherwise></c:choose></title>
                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-head am-cf">
                            <div class="widget-title am-fl">新建<c:choose><c:when test="${msgSend.type=='mail'}">站内信</c:when><c:otherwise>通知</c:otherwise></c:choose></div>
                        </div>
                        <div class="widget-body am-fr">
                            <form id="mform" class="am-form tpl-form-border-form" data-am-validator modelAttribute="msgSend" method="post">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-10" id="usersHtml">
                                        <button type="button" class="am-btn am-btn-xs am-btn-primary am-btn-xs" onclick="openModel(false,'${ctx}/user/selectUser?users=${msgSend.users}')"><span class="am-icon-plus"></span></button>
                                    </div>
                                </div>
                                <div class="am-form-group">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-10">
                                        <textarea id="content" name="content" rows="10" placeholder="请输入内容...">
                                ...
                                <div class="am-form-group">
                                    <div class="am-u-sm-10 am-u-sm-push-2">
                                        <button type="button" class="am-btn am-btn-xs am-btn-danger" onclick="closeModel(false)">取消</button>
                                        <button type="button" id="save" class="am-btn am-btn-xs am-btn-primary">保存草稿</button>
                                        <button type="button" id="send" class="am-btn am-btn-xs am-btn-primary">发送</button>
                                    </div>
                                </div>
                            </form>
                        </div>
...
<script type="text/template" id="usersTpl" desc="发送给模板">
    ...
    <button type="button" class="am-btn am-btn-xs am-btn-primary am-btn-xs"><#=item.name #><span class="close" onclick="removeUser('<#=item.id #>',this)"><span class="am-icon-remove"></span></span></button>
    <#}#>
        <button type="button" class="am-btn am-btn-xs am-btn-primary am-btn-xs" onclick="openModel(false,'${ctx}/user/selectUser?users=<#=ids #>')"><span class="am-icon-plus"></span></button>
</script>
