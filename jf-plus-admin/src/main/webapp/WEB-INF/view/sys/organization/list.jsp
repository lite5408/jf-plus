                                    ...
                                    <div class="am-btn-group am-btn-group-xs">
                                        <shiro:hasPermission name="sys:organization:edit">
                                            <button type="button" class="am-btn am-btn-default am-btn-success"
                                                    onclick="openModel('创建','${ctx}/organization/create?id=${page.entity.id}')"><span class="am-icon-plus"></span> 新增
                                ...
                                <table id="contentTable" class="am-table am-table-compact am-table-striped tpl-table-black">
                                    ...
                                    <c:forEach items="${page.list}" var="org" varStatus="status">
                                        <tr>
                                            ...
                                            <td>${org.no}</td>
                                            <td>${org.name}</td>
                                            <td>${fnc:getEnumText('com.jf.plus.common.core.enums.OrgType',org.type)}</td>
