            ...
            <div class="widget-body am-fr">
              <div class="am-u-sm-12 am-u-md-3 am-u-lg-3">
                <div class="am-btn-toolbar">
                  <div class="am-form-group">
                    <button type="button" class="am-btn am-btn-xs am-btn-danger am-btn-xs" onclick="closeModel(false)">取消选择</button>
                    <button type="button" id="okSelect" class="am-btn am-btn-xs am-btn-primary am-btn-xs" onclick="">确认选择</button>
                  </div>
                </div>
              </div>
              ...
              <div class="am-u-sm-12 am-u-md-9 am-u-lg-9">
                <form id="searchForm" action="${ctx}/user/selectUser" method="post">
                  ...
                  <input id="organizationId" name="organizationId" type="hidden" value="${page.entity.organizationId}"/>
                  <input id="users" name="users" type="hidden" value="<c:forEach items="${users}" var="item">${item},</c:forEach>"/>
