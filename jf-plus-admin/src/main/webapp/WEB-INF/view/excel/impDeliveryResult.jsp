                        ...
                        <div class="widget-body am-fr">
				          <div class="am-btn-toolbar">
				            <div class="am-btn-group am-btn-group-xs">
				              <a href="${ctx }/order/orderDelivery/toDeliveryProdList" class="am-btn am-btn-xs am-btn-primary"> 返回</a>
				            </div>
				          </div>
				        </div>
                        <div class="widget-body am-fr">
							  	...
							  	<c:if test="${result.code == 403 }">
						              ...
						              <thead>
						              	<tr>
											...
											<th class="table-title">代理商</th>
											<th class="table-title">颜色</th>
											<th class="table-title">尺寸</th>
											<th class="table-title">订货数量</th>
											<th class="table-title">包裹号</th>
											<th class="table-title">发货数量</th>
						              ...
						              <tbody>
							              <c:forEach items="${result.obj}" var="rowList">
								              <tr>
								              	...
								              	<td>${rowList[7]}</td>
								              	<td>${rowList[8]}</td>
								              	<td><span class="error">${rowList[9]}</span></td>
								              </tr>
							              </c:forEach>
						              </tbody>
						            </table>
