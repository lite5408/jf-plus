					...
					<div class="widget am-cf">
						...
						<div class="widget-body am-fr">
								...
								<div class="am-btn-toolbar">
									<div class="am-btn-group am-btn-group-xs">
										<button type="button" class="am-btn am-btn-default am-btn-success"
												onclick="openModel('创建','${ctx}/scheduleJob/create')"><span class="am-icon-plus"></span> 新增
										</button>
									</div>
								</div>
							</div>
							...
							<div class="am-u-sm-12 am-u-md-9 am-u-lg-9">
								<form id="searchForm" action="${ctx}/scheduleJob" method="post">
									...
									<div class="am-input-group am-input-group-sm tpl-form-border-form cl-p">
										<div class="tagsinput">
											<c:if test="${not empty page.entity.jobName}"><span class="tags"><input type="hidden" name="jobName" value="${page.entity.jobName}" />任务名称=${page.entity.jobName} <a href="javascript:;" onclick="$(this).parent().remove()">x</a></span></c:if>
                                                <span class="am-select am-input-group-sm">
                                                     <input type="text" class="am-select-input" autocomplete="off" style="border: none;"
															placeholder="关键字" am-data='[{"field":"jobName","desc":"任务名称","type":"string"}]'>
							...
							<div class="am-u-sm-12 am-scrollable-horizontal">
								<table id="contentTable" class="am-table am-table-compact am-text-nowrap tpl-table-black" width="100%">
									<thead>
									<tr>
										<th>序号</th>
										<th>任务名称</th>
									...
									<c:forEach items="${page.list}" var="scheduleJob" varStatus="status">
										<tr>
											...
											<td>
												...
												<a href="javascript:;" onclick="openModel(false,'${ctx}/scheduleJob/update?id=${scheduleJob.id}')" title="修改"><span class="am-icon-pencil"></span></a>
