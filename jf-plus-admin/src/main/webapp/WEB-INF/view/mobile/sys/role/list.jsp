								...
								<div class="am-btn-toolbar">
									<div class="am-btn-group am-btn-group-xs">
										...
										<button type="button" class="am-btn am-btn-default am-btn-success"
												onclick="openModel('创建','${ctx}/role/update')"><span class="am-icon-plus"></span> 新增
								...
								<table id="contentTable"  class="am-table am-table-compact am-text-nowrap tpl-table-black" width="100%">
									...
									<c:forEach items="${page.list}" var="role" varStatus="status">
										<tr>
											...
											<td>${role.remarks}</td>
											<td>
												<shiro:hasPermission name="sys:role:view"><a href="javascript:;" onclick="openModel(false,'${ctx}/role/update?id=${role.id}')" title="编辑"><span class="am-icon-pencil"></span></a></shiro:hasPermission>
