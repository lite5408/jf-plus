				...
				<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
					<div class="widget am-cf">
						...
						<div class="widget-body am-fr">
							<form class="am-form tpl-form-border-form" data-am-validator modelAttribute="organization" action="${ctx}/organization/update" method="post">
								...
								<div class="am-form-group">
									<div class="am-u-sm-12">
										<shiro:hasPermission name="sys:organization:edit"><button type="submit" class="am-btn am-btn-xs am-btn-primary">保存</button></shiro:hasPermission>
