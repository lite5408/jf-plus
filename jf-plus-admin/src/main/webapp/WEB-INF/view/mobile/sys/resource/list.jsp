									...
									<div class="am-btn-group am-btn-group-xs">
										<shiro:hasPermission name="sys:resource:edit">
											<button type="button" class="am-btn am-btn-default am-btn-success"
													onclick="openModel('创建','${ctx}/resource/create?id=${page.entity.id}')"><span class="am-icon-plus"></span> 新增
									...
									<c:forEach items="${page.list}" var="resource" varStatus="status">
										<tr>
											...
											<shiro:hasPermission name="sys:resource:edit"><td>
												<a href="javascript:;" onclick="openModel(false,'${ctx}/resource/update?id=${resource.id}')" title="编辑"><span class="am-icon-pencil"></span></a>
