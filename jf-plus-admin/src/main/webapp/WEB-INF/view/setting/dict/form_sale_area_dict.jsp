                    ...
                    <div class="widget am-cf">
                        ...
                        <div class="widget-body am-fr">
                            <form class="am-form tpl-form-border-form" data-am-validator modelAttribute="dict" action="${ctx}/setting/dict/<c:choose><c:when test="${empty dict.id}">create</c:when><c:otherwise>update</c:otherwise></c:choose>" method="post">
									...
									<input type="hidden" name="pids" value="${dict.pids }" />
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" name="key" placeholder="区域编码" value="${dict.key}" required unique/>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        <label class="am-u-sm-3 am-form-label">区域名称：</label>
                                        <div class="am-u-sm-9">
                                            <input type="text" name="val" placeholder="区域名称" value="${dict.val}" required/>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        <label class="am-u-sm-3 am-form-label">类型：</label>
                                        <div class="am-u-sm-9">
                                            <select name="type" data="${dict.type }" >
                                            	 <c:choose>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="number" name="sort" placeholder="排序" value="${dict.sort}"/>
                                        </div>
                                    </div>
                            <div class="am-form-group">
...
<script type="text/javascript">
    ...
    $('[unique]').blur(function(){
		...
		post("${ctx}/setting/dict/unique",{dict:'${dict.dict}',id:'${dict.id}',key:$(this).val()},function(result){
			if(result.obj >= 1){
				alert('编码重复，请重新输入');
				$('[unique]').val('');
				return false;
