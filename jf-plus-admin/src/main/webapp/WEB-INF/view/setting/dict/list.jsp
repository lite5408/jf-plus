                                        ...
                                        <td class="am-padding-sm">
                                            <shiro:hasPermission name="setting:dict:create">
                                                <button type="button" class="am-btn am-btn-xs am-btn-default am-btn-success"
                                                        onclick="openModel(false,'${ctx}/setting/dict/create')"><span class="am-icon-plus"></span> 新增
                                                </button>
                                            </shiro:hasPermission>
                                        </td>
                                    </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <shiro:hasPermission name="setting:dict:update">
                                                    <a role="oper" href="javascript:;" onclick="openModel('修改字典表','${ctx}/setting/dict/update?id=${dict.id}')" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil"></span> 编辑</a>
                                                </shiro:hasPermission>
                                                </div>
                                            </td>
                                        </tr>
