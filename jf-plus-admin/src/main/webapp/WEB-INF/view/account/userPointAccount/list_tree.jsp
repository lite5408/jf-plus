                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="am-btn-group am-btn-group-xs">
							                      	<a role="oper" href="javascript:" class="am-btn am-btn-default am-btn-xs am-text-secondary" onclick="openModel('充值','${ctx}/account/userPointAccount/recharge?id=${user.id }')"><span class="am-icon-pencil-square-o"></span> 充值</a>
                                                </div>
                                            </td>
                                        </tr>
                                    </c:forEach>
