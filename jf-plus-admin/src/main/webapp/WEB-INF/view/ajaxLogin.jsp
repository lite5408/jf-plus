            ...
            <form class="am-form tpl-form-line-form" id="loginForm" method="post">
                ...
                <div class="am-form-group">
                    <div class="am-g">
                        <div class="am-u-sm-6" style="padding-left: 1.5rem;padding-right: 1.5rem;">
                            <div class="color-form-group color-form-line color-floating-label">
                                <input class="color-form-control tpl-form-input" type="text" id="jcaptchaCode" name="jcaptchaCode" required>
                ...
                <div class="am-form-group">
                    <button type="button" id="login"
                            class="am-btn am-btn-xs am-btn-primary  am-btn-block tpl-btn-bg-color-success  tpl-login-btn">登 录
                    </button>
                </div>
            </form>
        </div>
