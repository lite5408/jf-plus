                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-head am-cf">
                            <div class="widget-title am-fl">订单查询</div>
                        </div>
                        <div class="widget-body am-fr">
                            ...
                            <div class="am-u-sm-12 am-u-md-10 am-u-lg-10">
                                <form id="searchForm" action="${ctx}/order/jf/list" method="post">
                            ...
                            <div class="am-u-sm-12">
                                <table id="contentTable" class="am-table am-table-compact am-table-striped tpl-table-black">
                                    ...
                                    <c:forEach items="${page.list}" var="row" varStatus="status">
                                        <tr>
                                                <td>${fn:substring(row.orderNo,12,21)}</td>
                                                <td>${row.orgName}</td>
                                                <td>${row.userName }</td>
                                                <td>
                                            ...
                                            <td>
                                                <div class="am-btn-group am-btn-group-xs">
                                                	<c:if test="${row.operStatus != 11 or row.operStatus != 12 }">
                                                    	<a role="oper" href="javascript:;" onclick="openModelAdjust('物流详情','${ctx }/order/track?outTradeNo=${row.outTradeNo}&source=${row.source }',false,false)" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-check"></span> 查询物流</a>
                                                	</c:if>
                                                </div>
                                            </td>
                                        </tr>
...
<script type="text/javascript">
    ...
    function exportFun(){
    	location.href = "${ctx }/export/jf/order/excel?pageNo=0&operStatus=${page.entity.operStatus}" + 
