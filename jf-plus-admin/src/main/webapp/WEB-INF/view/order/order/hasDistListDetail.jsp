                    ...
                    <div class="widget am-cf">
                        <div class="widget-body am-fr">
                       	...
                       	<div class="am-u-sm-12 am-text-center">
                       		<a href="${ctx}/export/distOrderList?itemId=${page.entity.itemId}&isDist=1&batchNo=${page.entity.batchNo}" class="am-btn am-btn-primary am-btn-xs">导出Excel</a>
                            <button type="button" class="am-btn am-btn-xs am-btn-warning" onclick="closeModel(false)">关闭</button>
                        </div>
                    </div>
                </div>
            </div>
